...
BATCH_SIZE = 2
EPOCHS = 5
N_SAMPLES = 2000           # how many rows we want in our synthetic dataset
...
tok = AutoTokenizer.from_pretrained("runs/predllm-mini/model")
model = AutoModelForCausalLM.from_pretrained("runs/predllm-mini/model")
model.to("cpu")
model.eval()
